...
import StackOverflow.XMLParser.Posts.Model.QAModel;

public class QASolrWriter {

	
	// create a new document and write to the XML
	public static void createAndWriteToSolr(QAModel qAModel) throws Exception {
	...
	public static void appendToSolr(QAModel qAModel) throws Exception {
